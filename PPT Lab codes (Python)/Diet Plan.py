...
def combine(asd,items,shortfall,min=[99999]*3):
    ...
    for item in items:
        ...
        print("asd:",asd,"min:",min)
        flag=combine(asd+1,items,shortfall)
        print("asd:",asd,"min:",min)
        ...
        if(flag==-1):
            if (min[0]>=shortfall[0] and min[1]>=shortfall[1] and min[2]>=shortfall[2]):
                for i in range(3):
                    min[i]=shortfall[i] 
            elif (min[0]>=shortfall[0] and min[1]>=shortfall[1] and min[2]<shortfall[2]):
                for i in range(3):
                    min[i]=shortfall[i] 
            elif (min[0]>=shortfall[0] and min[1]<shortfall[1] and min[2]<shortfall[2]):
                for i in range(3):
