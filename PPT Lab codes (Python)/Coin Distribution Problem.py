...
table=[[0,0,0],[0,0,1],[0,0,2],[0,1,1],[0,1,2],[0,2,1],[0,2,2],[0,2,3],[0,3,2],[1,1,2],[1,2,1]]
one=0
two=0
five=0
if n>10:
    if n%10>5:
        five=(n//10)*2
        index=n%10    
        one=one+table[index][2]
        two=two+table[index][1]
        five=five+table[index][0]    
